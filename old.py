...
class User(db.Model):  # work in progress...
    ...
    # Takes in some thing like "93;123" which is the id of the post
    all_posts = db.Column(String(500_000_000), default='')

    def __init__(self, email, username, hashed_password, user_id):
...
def new_signup():
    ...
    if request.method == 'POST':
        ...
        new_user = User(username=username, hashed_password=hashed_password,
                        email=email, user_id=hex(random.randint(100_100, 999_999)))
